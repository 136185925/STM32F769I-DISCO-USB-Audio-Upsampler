...
/* C1A1h oscillator setting used by the ST panel initialization sequence.
 * Keep the panel TE/scan cadence at 65 Hz (the controller default is 60 Hz). */
#define OTM8009A_NORMAL_REFRESH_65HZ  0x08U
