...
#define AUDIO_OUT_IRQ_PREPRIO                    ((uint32_t)0x06)
...
/* Select the interrupt preemption priority and subpriority for the DMA interrupt */
#define AUDIO_IN_IRQ_PREPRIO                ((uint32_t)0x07)
...
#define AUDIODATA_SIZE                      2   /* Legacy 16-bit default; audio out also supports 24-bit words. */
