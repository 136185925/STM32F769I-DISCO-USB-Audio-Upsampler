...
typedef enum
{
  ...
  USB_AUDIO_SPDIF_UPSAMPLE_4X_HYBRID_NS2 = 7,
  USB_AUDIO_SPDIF_UPSAMPLE_4X_BUTTERWORTH_NS2 = 8,
  USB_AUDIO_SPDIF_UPSAMPLE_4X_BUTTERWORTH_MINPHASE_NS2 = 9,
  USB_AUDIO_SPDIF_UPSAMPLE_4X_BESSEL_MINPHASE_NS2 = 10,
  USB_AUDIO_SPDIF_UPSAMPLE_4X_BESSEL_OPEN_NS2 = 11,
  USB_AUDIO_SPDIF_UPSAMPLE_4X_BESSEL_MINPHASE_NS5 = 12,
  USB_AUDIO_SPDIF_UPSAMPLE_4X_FIR_MINPHASE_NS5 = 13,
  USB_AUDIO_SPDIF_UPSAMPLE_4X_WLS_MINPHASE_NS5 = 14,
  USB_AUDIO_SPDIF_UPSAMPLE_4X_WLS_LINEARPHASE_NS5 = 15,
  USB_AUDIO_SPDIF_UPSAMPLE_4X_WLS_LISTEN_NS5 = 16
} USB_AudioSpdifMode;
