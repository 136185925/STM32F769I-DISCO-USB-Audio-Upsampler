...
void MX_USB_OTG_HS_PCD_Init(void)
{
  ...
  /* Explicit asynchronous USB Audio feedback is paced from the UAC1
     bRefresh interval in USBD_AUDIO_SOF(). */
...
void HAL_PCD_MspInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  /* USER CODE END USB_OTG_HS_MspInit 0 */
    ...
    */
    ...
    /* Raw SD polling is executed by the MSC callbacks. Keep USB below the
       RTC, touch and RTOS-critical IRQs so transfers cannot add timer jitter. */
